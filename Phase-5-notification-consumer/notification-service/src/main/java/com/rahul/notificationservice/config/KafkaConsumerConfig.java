...
public class KafkaConsumerConfig {
    ...
    public ConcurrentKafkaListenerContainerFactory<String, ConfirmOrderCommand> confirmOrderContainerFactory() {
        ...
        factory.setConsumerFactory(consumerFactory("notificationservice-confirm-group", ConfirmOrderCommand.class));
        return factory;
    }
    ...
    public ConcurrentKafkaListenerContainerFactory<String, OrderFailedCommand> orderFailedContainerFactory() {
        ...
        factory.setConsumerFactory(consumerFactory("notificationservice-failed-group", OrderFailedCommand.class));
        return factory;
    }
}